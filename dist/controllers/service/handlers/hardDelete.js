...
const deletePermanentService = new index_1.DeletePermanentService();
    ...
    try {
        ...
        if (error.message?.includes("associated with existing appointments")) {
            return res.status(409).json({
                message: "This service cannot be permanently deleted because it is associated with existing appointments. Archive it instead.",
            });
        }

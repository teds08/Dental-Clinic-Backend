...
//coupon routes
router.post("/create/coupons",authenticate,adminOnly,(req,res)=>couponController.createCoupon(req,res));
...
router.post("/redeem/coupon",authenticate,(req, res) => couponController.redeemCoupon(req, res));
